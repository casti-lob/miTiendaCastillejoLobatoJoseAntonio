...
<body>
	...
	<h1 class="display-2">Estas seguro de eliminar esta película</h1>
		<div class="card">
		      <div class="card-body">
		        <h5 class="card-title">Película: <%=movie.getTitle()%></h5>
		       ...
		       <a href="Article.jsp" class="btn btn-primary">Cancelar</a>
