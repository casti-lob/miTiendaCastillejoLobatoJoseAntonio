...
public class ErrorLogin extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			out.println("<!-- Contenedor -->\r\n"
					...
					+"<a href=\"../Index.jsp\" class=\"btn btn-primary\">Iniciar sesión</a>\r\n"
					+ "	</div>\r\n"
					+ "	<!-- Contenedor -->");
	...
	protected void unlogger(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException{
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		try {
			...
			out.println("<!-- Contenedor -->\r\n"
					+ "	<div class=\"container\">\r\n"
					+ "		<h1 class=\"display-2\">Tienes que tener una cuenta para acceder</h1>\r\n"
					+"<a href=\"../Index.jsp\" class=\"btn btn-primary\">Iniciar sesión</a>\r\n"
					+ "	</div>\r\n"
					+ "	<!-- Contenedor -->");
